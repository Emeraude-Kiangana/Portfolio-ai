    ...
    <main className="min-h-screen bg-zinc-950 px-6 py-16 text-zinc-100 sm:px-10 lg:px-24">
      <div className="mx-auto max-w-5xl">
        ...
        <section className="grid gap-4 py-10 sm:grid-cols-4">
          ...
          <div className="rounded-xl border border-zinc-800 bg-zinc-900/30 p-5">
            <p className="text-sm text-zinc-400">Regression</p>
        ...
        <section className="border-t border-zinc-800 py-10">
          ...
          <video
            className="mt-6 w-full rounded-xl border border-zinc-800 bg-black"
            controls
            preload="metadata"
          >
          ...
          <div className="mt-5 flex flex-col gap-3 sm:flex-row">
            <a
              href={videoUrl}
              className="rounded-lg bg-zinc-100 px-5 py-3 text-center font-medium text-zinc-950 hover:bg-white focus:outline-none focus:ring-2 focus:ring-zinc-200 focus:ring-offset-2 focus:ring-offset-zinc-950"
            >
              Ouvrir le MP4
            </a>
            <a
              href={checksumUrl}
              className="rounded-lg border border-zinc-700 px-5 py-3 text-center font-medium hover:bg-zinc-900 focus:outline-none focus:ring-2 focus:ring-zinc-200 focus:ring-offset-2 focus:ring-offset-zinc-950"
            >
        ...
        <section className="border-t border-zinc-800 py-10">
          ...
          <dl className="mt-6 grid gap-5 sm:grid-cols-2 text-zinc-300">
            <div>
              <dt className="font-semibold text-zinc-100">Release</dt>
              <dd className="mt-1 font-mono text-sm">{version}</dd>
            </div>
            <div>
              <dt className="font-semibold text-zinc-100">Release commit</dt>
              <dd className="mt-1 break-all font-mono text-sm">{releaseCommit}</dd>
            </div>
            <div>
              <dt className="font-semibold text-zinc-100">Normalized main</dt>
              <dd className="mt-1 break-all font-mono text-sm">{normalizedMain}</dd>
            </div>
            <div>
              <dt className="font-semibold text-zinc-100">Normalized main CI</dt>
              <dd className="mt-1 font-mono text-sm">{normalizedCi} — SUCCESS</dd>
            </div>
            <div>
              <dt className="font-semibold text-zinc-100">Reference release CI</dt>
              <dd className="mt-1 font-mono text-sm">{referenceCi} — SUCCESS</dd>
            </div>
            <div>
              <dt className="font-semibold text-zinc-100">SHA-256 du MP4</dt>
